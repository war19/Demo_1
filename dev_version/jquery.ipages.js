...
;(function($, window, document, undefined) {
	...
	iPages.prototype = {
		...
		defaults: {
			...
			pageWidth: 350, // Sets the book page width in px
			pageHeight: 490, // Sets the book page height in px
		...
		_updateStagePadding: function(padding) {
			if(typeof padding === 'number') {
				...
				this.stagePadding.top = (padding.hasOwnProperty('top') ? padding.top : 5);
				this.stagePadding.right = (padding.hasOwnProperty('right') ? padding.right : 5);
				this.stagePadding.bottom = (padding.hasOwnProperty('bottom') ? padding.bottom : 5);
				this.stagePadding.left = (padding.hasOwnProperty('left') ? padding.left : 5);
			}
		},
